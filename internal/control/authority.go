...
const (
	...
	// OpBoard is the cross-project board of TASKS. It was called
	// "programme_board" until #86; the name predates programmes being plane state
	// and promised a subject the board has never had. Safe to rename because it is
