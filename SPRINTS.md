...
_No active sprint, and no active milestone. Milestone 18 (Control-Plane Hardening) closed with Sprint 64 in v0.53.0, which acted on the post-arc external review. The next focus is undecided — the two findings that review left standing are BACKLOG #69 (real execution termination) and #70 (a durable scheduler), and they are milestone-sized._
