...
func printUsage() {
	...
	fmt.Println("       daedalus task [create | list | status <id> | dispatch <id> | verify <id> | cancel <id>]")
	...
	fmt.Println("  task create|list|status|dispatch|verify|cancel  Host-side control-plane tasks")
	fmt.Println()
