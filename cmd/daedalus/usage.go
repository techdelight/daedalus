...
func printUsage() {
	...
	fmt.Println("       daedalus task [create | list | status <id> | dispatch <id> | cancel <id>]")
	...
	fmt.Println("  task create|list|status|dispatch|cancel  Host-side control-plane tasks (Git-native)")
	fmt.Println()
