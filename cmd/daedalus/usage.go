...
func printUsage() {
	...
	fmt.Println("                      approvals | proposals | depends <id> | target |")
	fmt.Println("                      retry <id> | replan <id> |")
	...
	fmt.Println("       |approvals|proposals|depends|target|retry|replan|events|cancel")
	fmt.Println("                                Host-side control-plane tasks (budgets, verification,")
	fmt.Println("                                approval, race-safe integration, event log)")
	fmt.Println()
