...
func printUsage() {
	...
	fmt.Println("                      checks <id> | replan <id> --objective <text> [--rebase] |")
	...
	fmt.Println("       |approvals|proposals|depends|steer|board|target|retry|reverify|checks|refine")
	fmt.Println("       |replan|refine|events|cancel")
