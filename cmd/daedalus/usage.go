...
func printUsage() {
	...
	fmt.Println("                      retry <id> | replan <id> | events <id> | cancel <id>]")
	...
	fmt.Println("  task create|list|status|dispatch|verify|retry|replan|events|cancel")
	fmt.Println("                                Host-side control-plane tasks (budgets, verification, event log)")
	fmt.Println()
